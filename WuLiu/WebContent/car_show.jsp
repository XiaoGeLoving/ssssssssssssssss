...
usernameq=(String)session.getAttribute("name");
if(login==null)
{
%>
...
%>
  ...
  <%userNameq=rs.getString("UserName");%>
    <td width="31%" height="42" align="center"><%=userNameq%></td>
  </tr>
<%
 if(userNameq.equals(usernameq))
{
 %>
 <tr>
