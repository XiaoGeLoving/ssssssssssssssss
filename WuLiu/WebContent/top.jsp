...
class="a1">企业信息</a>&nbsp;|&nbsp;<a href="tool1_assistant.jsp" 

class="a1">辅助工具</a>&nbsp;|&nbsp;<a href="logout.jsp" class="a1">退出</a></th>
        </tr>
        ...
        <center>
        <table><tr>
        <th width="786" height="31" border="0" align="center" cellpadding="0" cellspacing="0"  valign="middle" background="image/4.jpg">
 
<marquee direction="left" behavior="slide">
<b>欢迎您的访问，我们将为你提供最新物流动态！！！</b>
</marquee></th></tr>
         </table></center>
...
<table width="100%" height="115" border="0" cellpadding="0" cellspacing="0" background="image/5.jpg" >
  ...
  <tr>
    <td valign="top">
    <table width="787" height="151" border="0" align="center" cellpadding="0" cellspacing="0" background="image/6.jpg">
      <tr>
