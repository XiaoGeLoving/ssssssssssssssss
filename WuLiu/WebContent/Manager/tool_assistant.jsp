              				...
              				<tr>
                				<td>
									...
									<input type="button" name="Submit2" value="确认"  class=go-wenbenkuang onclick="road();">
                                                           <input type="button" name="Submit3" class=go-wenbenkuang value="查看全部" onclick="window.open                                                              ('tool_road.jsp','','width=540,height=420,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes')">
                        							</div>
												</td>
                      						</tr>
                    						<tr>
