  ...
  <table width="786" border="1" align="center" cellpadding="0" cellspacing="0"bordercolor="#FFFFFF" bordercolordark="#333333" bordercolorlight="#FFFFFF">
    <tr>
      ...
      <td width="36%" height="43">
       <input type="text" name="TradeMark" size="20">
      </td>
    ...
    <tr>
      ...
      <td width="30%" height="42">
        <input type="text" name="CarLoad" size="15">吨
      </td>
    </tr>
    <tr>
      <td height="45" align="center">已使用年限：</td>
      <td height="45"><input name="UsedTime" type="text" size="20"></td>
    ...
    <tr>
      ...
      <td height="45"><input type="text" name="DriverName" size="20"></td>
      <td height="45" align="center">驾驶证号码：</td>
      <td height="45"><input type="text" name="LicenceNumber" size="20"></td>
    </tr>
    <tr>
      <td height="45" align="center">驾驶员驾龄</td>
      <td height="45"><input type="text" size="20" name="DriverTime">年</td>
    ...
    <tr>
      ...
      <td width="36%" height="45">
       <input type="text" name="LinkPhone" size="20">
      </td>
    ...
    <tr>
      ...
      <td width="84%" height="78" colspan="3">
       <textarea rows="3" name="Remark" cols="72"></textarea>
      </td>
    </tr>
    <tr>
