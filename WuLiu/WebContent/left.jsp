...
<table width="91%"  height="87"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="32%" height="30" align="center" valign="bottom"><div align="right"><b>用户名:</b></div></td>
            <td width="68%" align="center" valign="bottom"><input name="name" type="text" size="16" maxlength="20"></td>
          </tr>
          <tr>
            <td height="30" align="center"><div align="right"><b>密&nbsp;&nbsp;&nbsp;&nbsp;码:</b></div></td>
            <td height="20" width="68%" align="center"><input type="password" name="password" size="16" maxlength="26"></td>
          </tr>
          <tr>
...
<table width="92%" height="18"  border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
            <td  height="18" align="center"><b>欢迎<%=username%>回来 </b></td>      
        </tr> 
 </table>
<%}%>	
...
<table width="93%" height="18"  border="0" align="center" cellpadding="0" cellspacing="0">
<tr>
<td><img src="image/111.jpg" ></td>
</tr>
</table>
